...
(function($PS) {
  ...
  var path = (function () {
      var $156 = attr("path");
      var $157 = Data_String_Common.joinWith(" ");
      var $158 = Data_Functor.map(Data_Functor.functorArray)(printD);
      return function ($159) {
          return $156($157($158($159)));
      };
  })();
  var r = (function () {
      var $160 = attr("r");
...
(function($PS) {
  ...
  var arcAnimationDuration = Svg_Attributes.seconds(0.7);
...
(function($PS) {
  ...
  var toggleMaybe = function (z) {
      return function (mx) {
          ...
          throw new Error("Failed pattern match at View.Petrinet.PetrinetEditor (line 525, column 20 - line 527, column 21): " + [ mx.constructor.name ]);
      };
  };
                  ...
                  return function (dictShow1) {
                      return function (htmlIdPrefixMaybe) {
                          ...
                          var mkTransitionIdStr = function (dictShow2) {
                              var $184 = Data_Semigroup.append(Data_Semigroup.semigroupString)(netPrefix);
                              var $185 = prefixTransition(dictShow2);
                              return function ($186) {
                                  return $184($185($186));
                              };
                          };
                          var mkPlaceIdStr = function (dictShow2) {
                              var $187 = Data_Semigroup.append(Data_Semigroup.semigroupString)(netPrefix);
                              var $188 = prefixPlace(dictShow2);
                              return function ($189) {
                                  return $187($188($189));
                              };
                          };
                              ...
                              return function (v) {
                                  var svgTokens = function (tokens1) {
                                      return function (point1) {
                                          var $85 = Data_Eq.eq(Data_Monoid_Additive.eqAdditive(Data_Eq.eqInt))(tokens1)(Data_Monoid.mempty(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt)));
                                          if ($85) {
                          ...
                          var arcAnimationClass = function (dictShow2) {
                              var mkArcClass = function (dictShow3) {
                                  return function (tid) {
                                      return "arc_" + prefixTransition(dictShow3)(tid);
                                  };
                              };
                              var $190 = Data_Semigroup.append(Data_Semigroup.semigroupString)(netPrefix);
                              var $191 = mkArcClass(dictShow2);
                              return function ($192) {
                                  return $190(tokenAnimatedClass($191($192)));
                              };
                          };
                                  ...
                                  return function (v) {
                                      ...
                                      if (v instanceof View_Petrinet_Model.FocusPlace) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                              ...
                                              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                                  ...
                                                  $98.focusedPlace = focusedPlace$prime;
                                                  $98.msg = Data_Maybe.maybe("Focused")(Data_Function["const"]("Unfocused"))(v1.focusedPlace) + (" place " + (Data_Show.show(dictShow)(v.value0) + (" (" + (Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(Data_Map_Internal.lookup(dictOrd)(v.value0)(v1.netInfo.net.placeLabelsDict)) + ")."))));
                                                  return $98;
                                              })());
                                          });
                                      };
                                      if (v instanceof View_Petrinet_Model.UpdatePlace) {
                                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                              ...
                                              $108.netInfo = (function () {
                                                  var $105 = {};
                                                  for (var $106 in state.netInfo) {
                                                      if ({}.hasOwnProperty.call(state.netInfo, $106)) {
                                                          $105[$106] = state["netInfo"][$106];
                                                      };
                                                  };
                                                  $105.net = (function () {
                                                      var $102 = {};
                                                      for (var $103 in state.netInfo.net) {
                                                          if ({}.hasOwnProperty.call(state.netInfo.net, $103)) {
                                                              $102[$103] = state["netInfo"]["net"][$103];
                                                          };
                                                      };
                                                      $102.placeLabelsDict = Data_Map_Internal.insert(dictOrd)(v.value0.value0)(v.value0.value1)(state.netInfo.net.placeLabelsDict);
                                                      return $102;
                                                  })();
                                                  return $105;
                                              })();
                                              $108.msg = "Updated place " + (Data_Show.show(dictShow)(v.value0.value0) + ".");
                                              return $108;
                                          });
                                      };
                                      if (v instanceof View_Petrinet_Model.UpdateTransition && v.value0 instanceof View_Petrinet_Model.UpdateTransitionName) {
                                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                              ...
                                              $120.netInfo = (function () {
                                                  var $117 = {};
                                                  for (var $118 in state.netInfo) {
                                                      if ({}.hasOwnProperty.call(state.netInfo, $118)) {
                                                          $117[$118] = state["netInfo"][$118];
                                                      };
                                                  };
                                                  $117.net = (function () {
                                                      var $114 = {};
                                                      for (var $115 in state.netInfo.net) {
                                                          if ({}.hasOwnProperty.call(state.netInfo.net, $115)) {
                                                              $114[$115] = state["netInfo"]["net"][$115];
                                                          };
                                                      };
                                                      $114.transitionLabelsDict = Data_Map_Internal.insert(dictOrd2)(v.value0.value0)(v.value0.value1)(state.netInfo.net.transitionLabelsDict);
                                                      return $114;
                                                  })();
                                                  return $117;
                                              })();
                                              $120.msg = "Updated transition " + (Data_Show.show(dictShow2)(v.value0.value0) + ".");
                                              return $120;
                                          });
                                      };
                                      if (v instanceof View_Petrinet_Model.UpdateTransition && v.value0 instanceof View_Petrinet_Model.UpdateTransitionType) {
                                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                              ...
                                              $132.netInfo = (function () {
                                                  var $129 = {};
                                                  for (var $130 in state.netInfo) {
                                                      if ({}.hasOwnProperty.call(state.netInfo, $130)) {
                                                          $129[$130] = state["netInfo"][$130];
                                                      };
                                                  };
                                                  $129.net = (function () {
                                                      var $126 = {};
                                                      for (var $127 in state.netInfo.net) {
                                                          if ({}.hasOwnProperty.call(state.netInfo.net, $127)) {
                                                              $126[$127] = state["netInfo"]["net"][$127];
                                                          };
                                                      };
                                                      $126.transitionTypesDict = Data_Map_Internal.insert(dictOrd2)(v.value0.value0)(v.value0.value1)(state.netInfo.net.transitionTypesDict);
                                                      return $126;
                                                  })();
                                                  return $129;
                                              })();
                                              $132.msg = "Updated transition " + (Data_Show.show(dictShow2)(v.value0.value0) + ".");
                                              return $132;
                                          });
                                      };
                                      if (v instanceof View_Petrinet_Model.FocusTransition) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                              ...
                                              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                                  ...
                                                  $139.focusedTransition = focusedTransition$prime;
                                                  $139.msg = Data_Maybe.maybe("Focused")(Data_Function["const"]("Unfocused"))(v1.focusedTransition) + (" transition " + (Data_Show.show(dictShow2)(v.value0) + (" (" + (Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(Data_Map_Internal.lookup(dictOrd2)(v.value0)(v1.netInfo.net.transitionLabelsDict)) + ")."))));
                                                  return $139;
                                              })());
                                          });
                                      };
                                      if (v instanceof View_Petrinet_Model.FireTransition) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Svg_Util.beginElements("#" + (componentHtmlId + (" ." + arcAnimationClass(dictShow2)(v.value0))))))(function (v1) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                                                  var netMaybe$prime = Data_Functor.map(Data_Maybe.functorMaybe)(Data_Petrinet_Representation_Dict.fire(dictOrd)(Data_Semiring.semiringInt)(Data_Bag.groupBagF(Data_Bag.monoidBagF(Data_Bag.semigroupBagF(dictOrd)(Data_Monoid_Additive.semigroupAdditive(Data_Semiring.semiringInt))))(Data_Group.groupAdditive(Data_Ring.ringInt)))(v2.netInfo.net))(v2.netInfo.netApi.transition(v.value0));
                                                  var net$prime = Data_Maybe.fromMaybe(v2.netInfo.net)(netMaybe$prime);
                                                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                                      var $148 = {};
                                                      for (var $149 in v2) {
                                                      ...
                                                      $148.netInfo = (function () {
                                                          var $145 = {};
                                                          for (var $146 in v2.netInfo) {
                                                              if ({}.hasOwnProperty.call(v2.netInfo, $146)) {
                                                                  $145[$146] = v2["netInfo"][$146];
                                                              };
                                                          };
                                                          $145.net = net$prime;
                                                          return $145;
                                                      })();
                                                      $148.msg = "Fired transition " + (Data_Show.show(dictShow2)(v.value0) + (" (" + (Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(Data_Map_Internal.lookup(dictOrd2)(v.value0)(net$prime.transitionLabelsDict)) + ").")));
                                                      return $148;
                                                  })());
                                              });
                                          });
                                          ...
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                                  if (v.value0 instanceof View_Petrinet_Model.Arc) {
                                                      ...
                                                      $154.arcLabelsVisible = !v1.arcLabelsVisible;
                                                      return $154;
                                                  };
                                                  if (v.value0 instanceof View_Petrinet_Model.Place) {
                                                      ...
                                                      $157.placeLabelsVisible = !v1.placeLabelsVisible;
                                                      return $157;
                                                  };
                                                  if (v.value0 instanceof View_Petrinet_Model.Transition) {
                                                      ...
                                                      $160.transitionLabelsVisible = !v1.transitionLabelsVisible;
                                                      return $160;
                                                  };
                                                  throw new Error("Failed pattern match at View.Petrinet.PetrinetEditor (line 222, column 17 - line 225, column 94): " + [ v.value0.constructor.name ]);
                                              })());
                                          });
                                      };
                                      throw new Error("Failed pattern match at View.Petrinet.PetrinetEditor (line 183, column 20 - line 225, column 94): " + [ v.constructor.name ]);
                                  };
                              };
                          };
                          var svgTokenAnimated = function (dictShow2) {
                              return function (arc) {
                                  ...
                                  return Svg_Elements.circleNode([ Svg_Attributes.class_("css-token-animated"), Svg_Attributes.cx(0.0), Svg_Attributes.cy(0.0), Svg_Attributes.r(0.0) ])([ Svg_Elements.animateMotion([ Svg_Attributes.id(animationId), Svg_Attributes.class_(arcAnimationClass(dictShow2)(arc.tid)), Svg_Attributes.begin("indefinite"), Svg_Attributes.dur(View_Petrinet_Config.arcAnimationDuration), Svg_Attributes.repeatCount(1), Svg_Attributes.path(svgPath(arc.src)(arc.dest)) ])([  ]), Svg_Elements.animate([ Svg_Attributes.attributeName("opacity"), Svg_Attributes.from("0"), Svg_Attributes.to("1"), Svg_Attributes.begin(animationId + ".begin"), Svg_Attributes.dur(tokenFadeDuration), Svg_Attributes.fillAnim(Svg_Attributes.Freeze.value), Svg_Attributes.repeatCount(0) ]), Svg_Elements.animate([ Svg_Attributes.attributeName("r"), Svg_Attributes.from(Data_Show.show(Data_Show.showNumber)(0.0)), Svg_Attributes.to(Data_Show.show(Data_Show.showNumber)(1.5 * View_Petrinet_Config.tokenRadius)), Svg_Attributes.begin(animationId + ".begin"), Svg_Attributes.dur(tokenFadeDuration), Svg_Attributes.fillAnim(Svg_Attributes.Freeze.value), Svg_Attributes.repeatCount(0) ]), Svg_Elements.animate([ Svg_Attributes.attributeName("r"), Svg_Attributes.to(Data_Show.show(Data_Show.showNumber)(0.0)), Svg_Attributes.begin(animationId + ".end"), Svg_Attributes.dur(Svg_Attributes.seconds(1.0e-4)), Svg_Attributes.fillAnim(Svg_Attributes.Freeze.value), Svg_Attributes.repeatCount(0) ]) ]);
                              };
                          };
                                                  ...
                                                  return function (focusedPlace) {
                                                      return function (focusedTransition) {
                                                          ...
                                                          var svgTransitions = Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)((function () {
                                                              var $193 = Data_Functor.map(Data_Maybe.functorMaybe)(svgTransitionAndArcs(dictShow3));
                                                              var $194 = Data_Tuple.uncurry(mkTransitionAndArcsModel);
                                                              return function ($195) {
                                                                  return $193($194($195));
                                                              };
                                                          ...
                                                          var svgPlaces = Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)((function () {
                                                              var $196 = Data_Functor.map(Data_Maybe.functorMaybe)(svgPlace(dictShow));
                                                              return function ($197) {
                                                                  return $196(mkPlaceModel($197));
                                                              };
                                                          })())(v.net.places));
                          ...
                          var render = function (state) {
                              ...
                              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "w-5/6" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(componentHtmlId), Halogen_HTML_Properties.classes([ "petrinet-component", "css-petrinet-component", Halogen_HTML_Core.ClassName(arcLabelsVisibilityClass + (" " + (transitionLabelsVisibilityClass + (" " + placeLabelsVisibilityClass)))) ]) ])([ Svg_Elements.svg([ Svg_Attributes.viewBox(Data_Vec3_Vec3["_x"](sceneTopLeft))(Data_Vec3_Vec3["_y"](sceneTopLeft))(Data_Vec3_Vec3["_x"](sceneSize))(Data_Vec3_Vec3["_y"](sceneSize)) ])(netToSVG(dictOrd)(dictShow)(dictOrd1)(dictShow1)(state.netInfo)(layout)(state.focusedPlace)(state.focusedTransition)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "w-1/6" ]) ])((function () {
                                  if (disableMarkingsAndLabelVisibilityButtons) {
                                      return [  ];
                                  };
                                  return [ htmlMarking(dictShow)(Data_Show.showInt)(state.netInfo.net.marking), labelVisibilityButtons ];
                              })()) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "w-1/6", "px-2" ]) ])([ Data_Maybe.maybe(View_Common.emptyHtml)((function () {
                                  var $198 = View_Common.mapAction(View_Petrinet_Model.UpdatePlace.create);
                                  return function ($199) {
                                      return $198(View_Petrinet_PlaceEditor["form'"]($199));
                                  };
                                  ...
                                  var $200 = View_Common.mapAction(View_Petrinet_Model.UpdateTransition.create);
                                  var $201 = View_Petrinet_TransitionEditor["form'"](state.netInfo.roleInfos);
                                  return function ($202) {
                                      return $200($201($202));
                                  };
                          ...
                          return Halogen_Component.mkComponent({
                              "eval": Halogen_Component.mkEval({
                                  ...
                                  receive: function ($203) {
                                      return Data_Maybe.Just.create(View_Petrinet_Model.LoadNet.create($203));
                                  },
